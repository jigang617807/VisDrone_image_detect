...
def run(
        weights='D:/yoloweb/yolo/yolov5s.pt',  # model.pt path(s)
        source='D:/yoloweb/yolo/data/images',  # file/dir/URL/glob, 0 for webcam
        data='D:/yoloweb/yolo/data/coco128.yaml',  # dataset.yaml path
        ...
        view_img=False,  # show results 是否展示预测之后的图片/视频, 默认False, --view-img 电脑界面出现图片或者视频检测结果
        ...
        project='D:/yoloweb/yolo/data/runs/detect',  # save results to project/name 保存测试日志的文件夹路径
...
def parse_opt(img):
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='D:/yoloweb/yolo/yolov5s.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=img, help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--data', type=str, default='D:/yoloweb/yolo/data/coco128.yaml', help='(optional) dataset.yaml path')
    ...
    parser.add_argument('--project', default='D:/yoloweb/yolo/data/runs/detect', help='save results to project/name')
